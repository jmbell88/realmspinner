<!-- Copied verbatim from .claude/skills/warlock-audit/references/constraints.md, so this skill stays self-contained (does not depend on warlock-audit's directory existing or being unchanged). Do not edit this copy separately from the original; if the original changes, re-copy it here. -->
