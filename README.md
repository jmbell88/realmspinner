...
Where to read more: the user manual is [docs/manual/00-index.md](docs/manual/00-index.md) (44 chapters, also embedded in the app), the hard invariants and their measured reasoning are `docs/INVARIANTS.md`, measurement write-ups are `docs/measurements/`, and `CHANGELOG.md` tracks releases.
