...
[The trellis binary](40-installation.md#the-trellis-binary) has the link and the build this version
...
deleted. [Data locations](41-configuration.md#data-locations) covers the environment variables that
