...
- **The mesh** — Resolution, Profile, Custom triangles and Game-ready triangles (the budgets the
  reconstruction is held to), Size in metres, and the seven engine flags: band width, texture
