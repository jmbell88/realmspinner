...
The assets under ``src/realmspinner/characters/amorphous/`` are **checked in**, for
...
def main(argv: list[str] | None = None) -> int:
    ...
    from realmspinner.characters.amorphous import generate

    directory = ROOT / "src" / "realmspinner" / "characters" / ARCHETYPE
