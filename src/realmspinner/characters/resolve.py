...
than an import of ``realmspinner.kernels.charsheet`` because this module is on the
...
def offer_sentence(
    ...
    return f"Realmspinner has no {asked} yet. The closest it makes is {_article(label)} {label}."
