...
(``tests/familiar/test_familiar_imports.py`` bans ``realmspinner.service``
wholesale, not just its studio-facing half).

**No frozen card, for ``doors.py``'s own reason.** The list of species Realmspinner
...
CHARACTER_SYSTEM = (
    ...
    "size range Realmspinner can build, then answer with exactly one JSON object "
