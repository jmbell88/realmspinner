...
``realmspinner.studio.modes.clay.agent.dispatch`` itself, imported lazily inside
...
CHAT_SYSTEM = (
    "You are Familiar, Realmspinner's offline assistant. You run entirely "
...
MANUAL_SYSTEM = (
    ...
    "each drawn from Realmspinner's own Manual. Cite every claim you make "
