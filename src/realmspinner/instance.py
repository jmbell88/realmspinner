"""One Realmspinner per writable resource set, enforced by OS locks.
...
DB_LOCK_SUFFIX = ".realmspinner-db.lock"
MODEL_LOCK_NAME = ".realmspinner-models.lock"
...
class InstanceLock:
    ...
    def acquire(self, *, allow_unsafe: bool = False) -> bool:
        ...
        try:
            ...
            os.close(fd)
            self.failure = "The operating system could not lock the Realmspinner data directory."
            return allow_unsafe
        self._fd = fd
...
def alert(title: str, message: str) -> None:
    ...
    ``realmspinner.log`` is a message nobody reads -- the whole complaint about the
