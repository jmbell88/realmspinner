...
Eight assemblies, one per skeleton in ``realmspinner/templates/``, so the Figures
...
headlessly; reaching into ``realmspinner/templates`` for a JSON file would buy an
