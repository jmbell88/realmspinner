...
Realmspinner's worst crash to date is host-commit exhaustion; a gigabyte held for
...
stdout back:
    ...
    -> @@realmspinner-matte@@ {"ok": true}
    -> @@realmspinner-matte@@ {"ok": false, "stage": "load"|"run", "error": "..."}
