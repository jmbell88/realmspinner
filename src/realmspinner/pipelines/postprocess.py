...
# The container format lives in realmspinner.glbio, shared with the viewer's loader.
...
def glb_to_collision(glb_path: Path, out_path: Path, *, max_hull_faces: int = 256) -> Path:
    ...
    For the props Realmspinner produces the hull is the shape a hand-made collider
