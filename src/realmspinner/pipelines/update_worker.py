...
``python -m realmspinner.pipelines.update_worker``, spawned by ``service.updates``,
...
#: safe.
RELEASES_URL = "https://api.github.com/repos/jmbell88/realmspinner/releases/latest"
...
def main() -> int:
    ...
    # workers -- this one, fetch_worker and pack_worker -- writing straight
