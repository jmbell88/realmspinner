...
def prune_jobs(svc: RealmspinnerService, keep: int = 20) -> dict[str, Any]:
...
def clean_jobs(svc: RealmspinnerService) -> dict[str, Any]:
...
def update_job(svc: RealmspinnerService, job_id: str, payload: dict[str, Any]) -> dict[str, Any]:
...
def set_front_yaw(svc: RealmspinnerService, job_id: str, degrees: float) -> dict[str, Any]:
...
def worker_is_inside(svc: RealmspinnerService, job_id: str) -> bool:
...
def dependent_jobs(svc: RealmspinnerService, job_id: str) -> list[str]:
...
def retained_job_ids(svc: RealmspinnerService) -> set[str]:
...
def _refuse_if_busy(svc: RealmspinnerService, job_id: str) -> None:
...
def trash_job(svc: RealmspinnerService, job_id: str) -> dict[str, Any]:
...
def restore_job(svc: RealmspinnerService, job_id: str) -> dict[str, Any]:
...
def empty_trash(svc: RealmspinnerService) -> dict[str, Any]:
...
def trash_size(svc: RealmspinnerService) -> dict[str, Any]:
...
def delete_job(svc: RealmspinnerService, job_id: str) -> dict[str, Any]:
    job = svc.require_job(job_id)
    if job["status"] == "running":
        raise Conflict("cancel the job before deleting it")
    _refuse_if_busy(svc, job_id)
