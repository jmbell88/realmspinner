...
def get_job(svc: RealmspinnerService, job_id: str) -> dict[str, Any]:
...
def storage(svc: RealmspinnerService) -> dict[str, Any]:
...
def storage_sizes(svc: RealmspinnerService) -> dict[str, int]:
