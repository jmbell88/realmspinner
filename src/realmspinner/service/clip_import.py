...
``service.clips`` already defines (:func:`~realmspinner.service.clips._lock`) --
...
def _imports_dir(svc: RealmspinnerService) -> Path:
...
def analyse(
    ...
    *,
    ...
    :func:`~realmspinner.cliptransfer.transfer` returns, unchanged, one entry per
...
def import_into_library(
    ...
    **Rotation space.** :func:`~realmspinner.cliptransfer.transfer` always emits
