...
def _lock(svc: RealmspinnerService) -> Any:
...
def library(svc: RealmspinnerService, template: str) -> dict[str, Any]:
...
def _commit_locked(svc: RealmspinnerService, key: str, document: dict[str, Any]) -> None:
...
def save(svc: RealmspinnerService, template: str, payload: dict[str, Any]) -> dict[str, Any]:
...
def revert(svc: RealmspinnerService, template: str) -> dict[str, Any]:
...
def preview_frames(svc: RealmspinnerService, template: str, clip: str) -> dict[str, Any]:
