...
# The vector vocabulary lives in ``realmspinner.vectors`` so the worker can import
...
def _summarise(records: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    # pure-stdlib with no ``realmspinner`` import: the reader gets the polarity rather
