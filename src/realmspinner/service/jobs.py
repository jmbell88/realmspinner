...
from .core import RealmspinnerService  # noqa: F401  -- historically importable
...
# their own (``realmspinner.service._jobs_*``). Nothing asserts a logger name.
log = logging.getLogger(__name__)


def create_generation_request(
    svc: RealmspinnerService, request: Any, **uploads: Any
) -> dict[str, Any]:
    """Queue a normalized :class:`realmspinner.generation.GenerationRequest`.
