...
The storage rules live in :mod:`realmspinner.poselib`; this module is what the Poser
...
def _record_or_not_found(svc: RealmspinnerService, pose_id: str) -> dict[str, Any]:
...
def _check_name_free(
    svc: RealmspinnerService, template: str, name: str, exclude: str | None = None
) -> None:
...
def _check_cap(svc: RealmspinnerService) -> None:
...
def list_library(svc: RealmspinnerService, template: str | None = None) -> dict[str, Any]:
    return {"poses": poselib.list_records(svc.config, template)}


def create_library_pose(svc: RealmspinnerService, payload: dict[str, Any]) -> dict[str, Any]:
    try:
...
def update_library_pose(
    svc: RealmspinnerService, pose_id: str, payload: dict[str, Any]
) -> dict[str, Any]:
...
def rename_library_pose(svc: RealmspinnerService, pose_id: str, name: str) -> dict[str, Any]:
    return update_library_pose(svc, pose_id, {"name": name})


def duplicate_library_pose(
    svc: RealmspinnerService, pose_id: str, name: str | None = None
) -> dict[str, Any]:
...
def delete_library_pose(svc: RealmspinnerService, pose_id: str) -> dict[str, Any]:
...
def library_for_job(svc: RealmspinnerService, job_id: str) -> dict[str, Any]:
...
def apply_library_pose(svc: RealmspinnerService, job_id: str, pose_id: str) -> dict[str, Any]:
...
def template_preview(svc: RealmspinnerService, template: str) -> Path:
