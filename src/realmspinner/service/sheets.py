...
def list_sheets(svc: RealmspinnerService, job_id: str) -> dict[str, Any]:
    check_job_id(job_id)
...
def check_sheet_cap(svc: RealmspinnerService, job_id: str, job_dir: Path) -> None:
...
def get_sheet(svc: RealmspinnerService, job_id: str, sheet_id: str) -> dict[str, Any]:
    check_job_id(job_id)
...
def sheet_png(svc: RealmspinnerService, job_id: str, sheet_id: str) -> Path:
    check_job_id(job_id)
    check_sheet_id(sheet_id)
    job_dir = svc.job_dir(job_id)
...
def _restyle_in_flight(svc: RealmspinnerService, sheet_id: str) -> bool:
...
def _rerender_in_flight(svc: RealmspinnerService, sheet_id: str) -> bool:
...
def _check_options(svc: RealmspinnerService, entries: dict[str, Any]) -> dict[str, Any]:
...
def _check_weights(svc: RealmspinnerService) -> None:
...
def get_pixel_sheet(svc: RealmspinnerService, job_id: str, sheet_id: str) -> dict[str, Any]:
    check_job_id(job_id)
    check_sheet_id(sheet_id)
...
def sheet_pixel_png(svc: RealmspinnerService, job_id: str, sheet_id: str) -> Path:
    check_job_id(job_id)
    check_sheet_id(sheet_id)
    job_dir = svc.job_dir(job_id)
