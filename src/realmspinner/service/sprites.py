...
def sprite_palettes(svc: RealmspinnerService) -> list[str]:
...
def get_sprite_draft(svc: RealmspinnerService, job_id: str, draft_id: str) -> dict[str, Any]:
    check_job_id(job_id)
...
def sprite_draft_png(
    svc: RealmspinnerService, job_id: str, draft_id: str, candidate: str
) -> Path:
...
def _synthesis_in_flight(svc: RealmspinnerService, draft_id: str) -> bool:
...
def delete_sprite_draft(
    svc: RealmspinnerService, job_id: str, draft_id: str
) -> dict[str, Any]:
    check_job_id(job_id)
    check_sprite_draft_id(draft_id)
