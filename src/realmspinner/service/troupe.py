...
``expand_clips`` is re-exported from ``realmspinner.clips``: the worker needs the
...
def troupe_options(svc: RealmspinnerService) -> dict[str, Any]:
...
def check_troupe(svc: RealmspinnerService, block: Any) -> dict[str, Any]:
...
def follow_up_sheet_job(svc: RealmspinnerService, rig_job_id: str) -> str | None:
...
def follow_up_failure(svc: RealmspinnerService, mesh_job_id: str) -> dict[str, Any] | None:
...
def _charsheet_row(
    svc: RealmspinnerService, job_id: str, sheet_id: str
) -> dict[str, Any] | None:
