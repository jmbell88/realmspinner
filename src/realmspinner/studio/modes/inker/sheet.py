...
``inker_ops`` registers the verbs and ``modes/inker/ui/panes/sheet.py`` draws the
...
# fresh render may do to each cell and :mod:`~realmspinner.studio.inker.sheetmerge`
