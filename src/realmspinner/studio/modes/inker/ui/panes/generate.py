...
:mod:`~realmspinner.studio.modes.inker.ops` -- but they were rows in the File menu and
...
:mod:`~realmspinner.kernels.pixel.inpaint`, because it acts on a *selection* inside
...
from ..... import anchors, controls, theme, tokens, widgets
...
def _exports(ctx: Any, tab: Any) -> None:
    """The five doors, drawn once from :mod:`~realmspinner.studio.modes.inker.export`.
