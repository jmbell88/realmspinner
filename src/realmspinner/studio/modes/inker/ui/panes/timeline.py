...
one grid. Realmspinner used to split the job across ``inker-layers`` (right column,
...
def _transport(ctx: Any, tab: Any) -> None:
    """One row, laid out by :mod:`~realmspinner.studio.toolbar`, then the switches.
    ...
    :data:`~realmspinner.studio.modes.inker.export.DOORS`, drawn by Inker's bridge under
...
_EXPORTS_MOVED_TO = "realmspinner.studio.modes.inker.export"
