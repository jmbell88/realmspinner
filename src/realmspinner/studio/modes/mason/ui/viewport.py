...
class MasonViewport:
    ...
    def _mason_viewport(self, ctx: Any, mason_mode: Any, widgets: Any) -> None:
        ...
        from .panes import header as mason_header
        from .panes import hud as mason_hud
        from .panes import menu as mason_menu
        ...
        # a ``.rscn`` or closed out from under the pointer lands correctly too.
    ...
    def _mason_empty(self, ctx: Any, mason_mode: Any) -> None:
        ...
        widgets.nothing_open(
            "Start a scene, open a document, or drop a .rscn on the window.",
            [
