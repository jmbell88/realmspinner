...
from .fileio import _decode, _resolve_source, _within_ceiling
from .state import active, ensure
...
def choose_layer_image(ctx: Any, layer_uid: int) -> None:
    ...
    ``.rmap`` already stores an image layer's pixels (as ``images/N.png``), so
