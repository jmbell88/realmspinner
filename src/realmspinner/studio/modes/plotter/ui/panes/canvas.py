...
from ..... import controls, docmodes, icons, theme, tokens, widgets
...
from ...engine import render as plotter_render
from ...engine import scene as plotter_scene
from ...engine import terrain as plotter_terrain
from ...engine import tools as plotter_tools
from ...engine.tilemap import ImageLayer, ObjectLayer, Polygon, Polyline, TileLayer, objects_in_rect
from . import layers as plotter_layers
from . import menu as plotter_menu
from . import textures as plotter_textures
...
def draw(ctx: Any) -> None:
    ...
    # two dialogs.
    from . import tools as tools_pane
...
def _rulers(tab: Any, draw_list: Any, origin, region, *, hovered: bool) -> None:
    ...
    from ..... import fonts
    from ....inker.ui.panes import canvas as inker_canvas
...
def _room_for(
    ...
    # height and in the dense window a ``.rmap`` stores, which is a visible
