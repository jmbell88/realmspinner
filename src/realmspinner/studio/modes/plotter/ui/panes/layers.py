...
from ...engine.props import CONTAINER_TYPES, PROPERTY_TYPES, Prop
from ...engine.tilemap import (
    BLEND_MODES,
    Capsule,
    Ellipse,
    GroupLayer,
...
def _layer_table(ctx: Any, doc: Any, layer: Any, editable: bool) -> None:
    ...
    with _table("##plotter-layer-table") as opened:
        ...
        if isinstance(layer, ObjectLayer):
            ...
            _row_named(
                "Picture",
                "The image this layer draws. It is stored in the .rmap rather "
...
def _goto_arrow(ctx: Any, value: Any) -> None:
    ...
    if ctx is None:
        return
    from . import objects as plotter_objects
