...
def can_edit_in_clay(job: Any) -> bool:
    ...
    because the inspector asks it every frame. ``build.rblk`` is deliberately
...
def _manifest_executor() -> Any:
    ...
    if _manifest_pool is None:
        ...
        _manifest_pool = ThreadPoolExecutor(
            max_workers=2, thread_name_prefix="realmspinner-manifest"
        )
