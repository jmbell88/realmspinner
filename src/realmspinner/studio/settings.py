...
class Settings:
    ...
    def load(cls, data_dir: Path) -> Settings:
        ...
        if not isinstance(raw, dict) or raw.get("version") != VERSION:
            ...
            out._reset("were written by a different version of Realmspinner")
            return out
    ...
    def _reset(self, why: str) -> None:
        ...
        self.data = {}
        self.notice = (
            f"Your Realmspinner preferences {why} and have been reset to defaults. "
            f"The old file was kept as {kept.name}."
            if kept is not None
            else f"Your Realmspinner preferences {why} and have been reset to defaults."
        )
