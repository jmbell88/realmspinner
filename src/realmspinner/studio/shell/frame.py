...
build the class it re-exports as ``realmspinner.studio.main.App``, so a module-scope
...
class FrameMixin:
    ...
    def _memory_ticker(self, now: float) -> None:
        ...
        # Child commit is included: Realmspinner's subprocesses are not incidental
