...
from ... import dialogs, docmodes, filetypes, fonts, journal
from ... import settings as settings_mod
from ...state import set_mode
from . import opening as inker_open
from . import ops as inker_ops
from . import palette_io as inker_palette_io
from . import playback as inker_playback
from . import state as inker_state
from .state import InkerDoc, InkerState
...
def _done_inpaint_land(ctx: Any, state: Any, done: Any) -> None:
    ...
    from .ui.panes import bridge as inker_bridge
...
def _done_flourish_render(ctx: Any, state: Any, done: Any) -> None:
    from . import flourish as inker_flourish
...
def _TASK_HANDLERS() -> dict[str, Any]:
    ...
    from . import flourish as inker_flourish  # noqa: F401 -- named by the table below
...
def _reload_linked(ctx: Any, tab: InkerDoc, doc: Any, load_error: str | None = None) -> None:
    ...
    if doc is None:
        ...
        return
    from .ui.panes import textures as inker_textures
...
_MOVED: dict[str, str] = {
    "COLOR_MODES": "palette_io",
    "COLOR_MODE_LABELS": "palette_io",
    "IMAGE_PALETTE_MAX": "palette_io",
    "MAX_PREVIEW_SPEED": "playback",
    "MIN_PREVIEW_SPEED": "playback",
    "PALETTE_STRIP_CELL": "palette_io",
    "REPEATABLE": "export",
    "_CHORD_NAMES": "keys",
    "_Export": "export",
    "_Leg": "export",
    ...
    "_Payload": "export",
    "_SLICE_SAFE": "export",
    "_begin_export": "export",
    "_ctrl_key": "keys",
    "_cut_matte": "opening",
    "_frame_palette": "export",
    "_load": "opening",
    "_load_aseprite": "opening",
    "_load_job": "opening",
    "_load_rendered_sheet": "opening",
    "_load_sprite_draft": "opening",
    "_modal": "keys",
    "_palette_text": "palette_io",
    "_report_import_warnings": "opening",
    "_slice_filenames": "export",
    "_split_stems": "export",
    "_submit_export": "export",
    "_suggest_grid": "opening",
    "_suggested_dialog_name": "export",
    "_write_palette": "palette_io",
    "animate": "playback",
    "ask_import_aseprite": "opening",
    "ask_import_sheet": "opening",
    "ask_open": "opening",
    "can_edit_job": "opening",
    "chord_of": "keys",
    "duplicate_document": "opening",
    "export_document_palette": "palette_io",
    "export_gif": "export",
    "export_palette": "palette_io",
    "export_palette_image": "palette_io",
    "export_per_layer": "export",
    "export_per_tag": "export",
    "export_png": "export",
    "export_pngs": "export",
    "export_range": "export",
    "export_sheet": "export",
    "export_slices": "export",
    "export_tag": "export",
    "frame_durations": "playback",
    "handle_key": "keys",
    "import_aseprite_path": "opening",
    "import_document_palette": "palette_io",
    "import_palette": "palette_io",
    "import_sheet": "opening",
    "index_to": "palette_io",
    "load_sheet_cells": "opening",
    "new_from_selection": "opening",
    "newest_sheet_after": "opening",
    "open_job_reference": "opening",
    "open_path": "opening",
    "open_pixel_artifact": "opening",
    "open_pixels": "opening",
    "open_rendered_sheet": "opening",
    "open_sprite_draft": "opening",
    "palette_from_image": "palette_io",
    "palette_strip": "palette_io",
    "pump_export": "export",
    "pump_undo_trim": "export",
    "release_all": "keys",
    "repeat_export": "export",
    "set_color_mode": "palette_io",
    "set_transparent_slot": "palette_io",
    "sheet_grid": "opening",
    "step_frame": "playback",
    "stop_play": "playback",
    "tick_playback": "playback",
    "tick_preview": "playback",
    "toggle_play": "playback",
    "toggle_preview": "playback",
}
