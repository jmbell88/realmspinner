...
``tests/modes/inker/fixtures/aseprite/`` is a *committed* corpus in the shape
``tests/modes/plotter/fixtures/tiled/`` set the precedent for: real files on disk,
...
corpus carries (``dev/INVARIANTS.md`` divergence 19) -- so a fixture's
