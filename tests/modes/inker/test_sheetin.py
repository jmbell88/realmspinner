...
from realmspinner.kernels.pixel import sheetin, sheetout
from realmspinner.kernels.pixel.animation import DIRECTION_ORDER, DirectionalLayout
...
def test_every_frame_gets_the_default_duration():
    from realmspinner.kernels.pixel.animation import DEFAULT_DURATION_MS
