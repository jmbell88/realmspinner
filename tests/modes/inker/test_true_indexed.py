...
from realmspinner.kernels.pixel.undo import (
    ColorStateEdit,
    CompoundEdit,
    IndexPatchEdit,
    IndexRemapEdit,
...
def test_palette_constrained_rgb_keeps_its_old_step_shapes():
    ...
    from realmspinner.kernels.pixel.undo import PaletteEdit
...
def test_the_undo_budget_sees_an_index_plane():
    ...
    from realmspinner.kernels.pixel.undo import _plane_bytes
