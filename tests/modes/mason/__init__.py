...
It is here for the reason ``tests/modes/clay/__init__.py`` is, only more so: Mason's
...
-- and three of those already exist under ``tests/modes/clay`` or would collide with
