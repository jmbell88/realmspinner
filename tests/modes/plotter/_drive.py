...
with a synthetic pointer, one call per frame, which is ``tests/modes/inker``'s
...
class TileScene:
    ...
    def __init__(
        ...
        *,
        ...
        from realmspinner.studio.modes.plotter.ui.panes.tileset_editor import COLLISION_VIEW
