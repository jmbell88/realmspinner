...
async def test_an_outer_outline_is_only_ever_drawn_when_asked_for(worker):
    ...
    ``tests/pipelines/test_spritesynth.py`` against a drawn atlas, and deliberately not
...
# pixel claims live in ``tests/pipelines/test_spritesynth.py``, against a drawn atlas.
