...
- mason-01 (`src/warlock/studio/mason/document.py`): the 2026-09-14 audit's
...
- mason-03 (`src/warlock/studio/panes/mason_menu.py`,
  `src/warlock/studio/panes/mason_outliner.py`): the viewport context menu
...
- mason-04 (`src/warlock/studio/mason_view.py`): `MasonView._terrain` was
